...
const PUBLIC_SEO = {
  ...
  '/study-material': {
    title: 'UPSC Study Material 2026 | Syllabus, NCERT Books & Magazines',
    description:
      'Free UPSC study material for CSE prelims and mains: official syllabus, NCERT books class 6 to 12, and Notes Cafe monthly current affairs magazines.',
    keywords: 'UPSC study material, UPSC notes PDF, IAS study material free, UPSC CSE resources',
  },
  ...
  '/maps': {
    ...
    description:
      'UPSC maps and atlas for Indian geography: rivers, mountains, national parks, biosphere reserves and important locations for prelims and mains.',
  ...
  '/government': {
    ...
    description:
      'UPSC government resources: schemes, constitution articles, important acts, committees, ministries, reports and indices.',
  ...
  '/planning-tools': {
    ...
    description:
      'Free UPSC planning tools: exam calendar, study planner, revision planner, pomodoro timer, timetable and goal tracker.',
  ...
  '/courses': {
    title: 'UPSC Courses | Foundation, Prelims, Mains & Mentorship',
    description:
      'Explore UPSC courses for beginners and serious aspirants: foundation, prelims, mains, CSAT, optional and mentorship paths.',
    keywords: 'UPSC courses, IAS coaching online, UPSC foundation course',
  },
  '/current-affairs': {
  ...
  '/resources': {
    title: 'UPSC Resources | Syllabus, Notes, Schemes & Subjects',
    description:
      'Browse UPSC resources by subject: polity, history, geography, economy, environment, ethics and government schemes.',
    keywords: 'UPSC resources, IAS notes by subject, UPSC GS resources',
  },
};
...
export const SITEMAP_PATHS = [
  ...
  '/maps/upsc-maps/important-locations',
  '/government',
  '/government/schemes',
...
export function websiteJsonLd() {
  return {
    ...
    potentialAction: {
      '@type': 'SearchAction',
      target: `${SITE_URL}/study-material?q={search_term_string}`,
