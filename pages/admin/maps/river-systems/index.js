...
export default function RiverSystemsAdmin() {
  ...
  return (
    <AdminLayout
      title="River Systems · Maps"
      subtitle={`${maps.length} rivers`}
      backHref="/admin/maps"
    >
      {maps.length === 0 ? (
        <div className="card p-12 text-center">
          ...
          <Link
            href="/admin/maps/river-systems/new"
            ...
            {maps.map((item, index) => (
              ...
              >
                ...
                <div className="flex gap-2">
                  <Link
                    href={`/admin/maps/river-systems/${item.id}/edit`}
      ...
      <div className="mt-4 flex gap-2">
        <Link href="/admin/maps/river-systems/new" className="btn btn-primary">
          Add River System
        </Link>
        <Link href="/admin/maps/import?category=river-systems" className="btn">
          Import CSV
        </Link>
      </div>
    </AdminLayout>
