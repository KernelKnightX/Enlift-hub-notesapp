...
const MOCK_PAPERS = [
  { id:'p1', year:'2024', exam:'UPSC CSE Prelims', paper:'General Studies I',   qs:100, mks:200, dur:'2 hours' },
  { id:'p2', year:'2024', exam:'UPSC CSE Prelims', paper:'CSAT',                qs:80,  mks:200, dur:'2 hours' },
  { id:'p3', year:'2024', exam:'UPSC CSE Mains',   paper:'Essay',               qs:2,   mks:250, dur:'3 hours' },
  { id:'p4', year:'2024', exam:'UPSC CSE Mains',   paper:'General Studies I',   qs:20,  mks:250, dur:'3 hours' },
  { id:'p5', year:'2024', exam:'UPSC CSE Mains',   paper:'General Studies II',  qs:20,  mks:250, dur:'3 hours' },
  { id:'p6', year:'2024', exam:'UPSC CSE Mains',   paper:'General Studies III', qs:20,  mks:250, dur:'3 hours' },
  { id:'p7', year:'2024', exam:'UPSC CSE Mains',   paper:'General Studies IV',  qs:12,  mks:250, dur:'3 hours' },
  { id:'p8', year:'2023', exam:'UPSC CSE Prelims', paper:'General Studies I',   qs:100, mks:200, dur:'2 hours' },
  { id:'p9', year:'2023', exam:'UPSC CSE Prelims', paper:'CSAT',                qs:80,  mks:200, dur:'2 hours' },
  { id:'p10',year:'2023', exam:'UPSC CAPF',        paper:'Paper I (GS)',        qs:125, mks:250, dur:'2 hours' },
  { id:'p11',year:'2023', exam:'UPSC CDS',         paper:'English',             qs:120, mks:100, dur:'2 hours' },
  { id:'p12',year:'2022', exam:'UPSC CSE Prelims', paper:'General Studies I',   qs:100, mks:200, dur:'2 hours' },
  { id:'p13',year:'2022', exam:'UPSC IFoS',        paper:'General English',     qs:8,   mks:300, dur:'3 hours' },
  { id:'p14',year:'2021', exam:'UPSC ESE',         paper:'General Studies',     qs:100, mks:200, dur:'2 hours' },
];
      ...
      <div className="mt-6 card overflow-hidden" data-testid="pyq-list">
        ...
        {filtered.map((p, i) => (
          ...
          >
            ...
            <button className="btn btn-ghost" style={{ padding: '0.5rem 0.9rem', fontSize: 12 }} data-testid={`pyq-view-${i}`}>
              <Eye size={14} strokeWidth={1.5} /> View
            </button>
            <button className="btn btn-primary" style={{ padding: '0.5rem 0.9rem', fontSize: 12 }} data-testid={`pyq-download-${i}`}>
