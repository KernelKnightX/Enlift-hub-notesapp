...
import {
  ...
  Home, Sparkles, TrendingUp, Coffee, ChevronRight, Shield, Loader2
} from "lucide-react";
...
export default function AdminDashboard() {
  ...
  const [stats, setStats] = useState({ users:0, currentAffairs:0, mockTests:0, pyqs:0, notifications:0, pdfSubjects:0 });
            ...
            {ACTIONS.map((a, i) => {
              ...
              return (
                <motion.div key={a.href}
                  ...
                  <Link href={a.href} className="card card-hover p-5 flex items-start gap-4 h-full block" data-testid={`admin-action-${a.tone}`}>
                    <div style={{
