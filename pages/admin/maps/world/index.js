...
export default function WorldAdmin() {
  ...
  return (
    <AdminLayout
      title="World Maps · Maps"
      subtitle={`${maps.length} world maps`}
      backHref="/admin/maps"
    >
      {maps.length === 0 ? (
        <div className="card p-12 text-center">
          ...
          <Link href="/admin/maps/world/new" className="btn btn-primary mt-5">
            Add World Map
          </Link>
        </div>
      ) : (
              ...
              >
                ...
                <div className="min-w-0">
                  <div className="flex flex-wrap items-center gap-2">
                    <span className="chip chip-primary">World</span>
                    <span
      ...
      <div className="mt-4 flex gap-2">
        <Link href="/admin/maps/world/new" className="btn btn-primary">
          Add World Map
        </Link>
        <Link href="/admin/maps/import?category=world" className="btn">
          Import CSV
        </Link>
      </div>
    </AdminLayout>
