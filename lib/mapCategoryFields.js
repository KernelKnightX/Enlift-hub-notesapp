...
const CATEGORY_CARD_UI = {
  "india-states": { badge: "Atlas map", action: "Open map" },
  world: { badge: "Atlas map", action: "Open map" },
  "river-systems": { badge: "River map", action: "Open map" },
  "mountain-ranges": { badge: "Relief map", action: "Open map" },
  "national-parks": { badge: "National park", action: "View details" },
  "biosphere-reserves": { badge: "Biosphere reserve", action: "View details" },
  "important-locations": { badge: "Location", action: "View details" },
};

export function getMapCardUi(category) {
  return CATEGORY_CARD_UI[category] || { badge: null, action: "View details" };
}
