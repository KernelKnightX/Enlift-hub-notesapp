...
export default function GovernmentLandingPage() {
  return (
    <>
      <Head>
        <title>Government Schemes, Acts and Polity Resources | Notes Cafe</title>
        <meta
          name="description"
          content="Browse government schemes, constitution articles, important acts, committees, ministries, and reports for UPSC preparation."
        />
      </Head>
      ...
      <ResourceLayout
        ...
        description="Schemes, articles, acts, committees, ministries, and reports in one place — with the same photo hero as the rest of the public library."
      >
        <section className="max-w-[1240px] mx-auto px-6 md:px-10 py-8 md:py-12">
          <SectionHeader
            eyebrow="Sections"
            title="Choose a government topic to explore."
            description="Schemes, constitution, acts, committees, ministries, and reports for exam-focused reading."
          />
