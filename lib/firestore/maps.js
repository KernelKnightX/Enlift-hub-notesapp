...
export function normalizeLengthKm(value) {
...
export function formatLengthKm(value) {
  const numeric = normalizeLengthKm(value);
  if (numeric === undefined) return "";
  return `${numeric.toLocaleString("en-IN")} km`;
}
...
export async function getPublishedMapsByCategory(category) {
