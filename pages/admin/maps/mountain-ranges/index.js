...
export default function MountainRangesAdmin() {
  ...
  return (
    <AdminLayout
      title="Mountain Ranges · Maps"
      subtitle={`${maps.length} ranges`}
      backHref="/admin/maps"
    >
      {maps.length === 0 ? (
        <div className="card p-12 text-center">
          ...
          <Link
            href="/admin/maps/mountain-ranges/new"
      ...
      <div className="mt-4 flex gap-2">
        ...
        <Link
          href="/admin/maps/import?category=mountain-ranges"
          className="btn"
        >
          Import CSV
        </Link>
